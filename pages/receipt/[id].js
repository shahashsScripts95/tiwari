...
export default function OPDReceipt() {
    ...
    const handlePrint = () => {
        const doc = new jsPDF();
        doc.text("Saurav Tiwari Hospital Management", 20, 20);
        doc.text("Chappalgaudi, Kohalpur-10, Banke", 20, 28);
        doc.text("-------------------------------------------------", 20, 34);
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 border rounded-lg shadow-md bg-white">
            <h1 className="text-2xl font-bold text-center mb-4">
                Saurav Tiwari Hospital Management
            </h1>
            <p className="text-center text-sm">
                Chappalgaudi, Kohalpur-10, Banke
            </p>
            <hr className="my-4" />
