...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <div className="mx-auto mt-10 max-w-6xl text-center sm:mt-20">
        <div>
          <h1 className="max-w-4xl mx-auto text-4xl font-extrabold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
            Welcome to <span className="text-blue-600"> Saurav</span> <br /> Hospital System!
          </h1>

          <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-600 sm:text-xl">
            This is a Hospital Management Sytem Designed by Saurav Tiwari.
          </p>
        </div>
      ...
      {/* Feature Section */}
      <div className="mx-auto mb-40 mt-20 max-w-5xl sm:mt-20">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
              <Typewriter
                words={["Our Departments"]}
                loop={true}
                cursor
                cursorStyle="|"
                typeSpeed={80}
            ...
            <p className="mt-4 text-lg text-gray-600">
              <Typewriter
                words={["We offer a wide range of medical specialties and services:"]}
                loop={true}
                cursor={false}
                typeSpeed={40}
              />
